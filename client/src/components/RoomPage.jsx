...
const mergeChatMessages = (history) => {
  ...
  <h2 className="text-xl font-orbitron text-gold-300 uppercase tracking-wide mb-4">
    Timer
  </h2>
  ...
  <div className="w-full flex flex-col gap-4">
    ...
    <div className="flex gap-2 justify-center">
      <input
        ...
        className="w-16 bg-[#0d1025] border border-yellow-300/20 rounded px-2 py-2 text-sm text-yellow-100 text-center"
        placeholder="Min"
      />
      <span className="font-mono text-yellow-100 flex items-center">:</span>
      <input
        type="number"
        min="0"
        max="59"
    ...
    <div className="flex flex-wrap gap-3 justify-center">
      <button
        ...
        className="bg-gold-300 text-black font-orbitron text-sm uppercase tracking-wide px-5 py-2 rounded shadow hover:brightness-110 transition"
      >
        Start
      </button>
      ...
      <button
        onClick={pauseTimer}
        className="bg-gold-200 text-black font-orbitron text-sm uppercase tracking-wide px-5 py-2 rounded shadow hover:brightness-110 transition"
      >
        Pause
      </button>
      ...
      <button
        onClick={resetTimer}
        className="bg-gold-100 text-black font-orbitron text-sm uppercase tracking-wide px-5 py-2 rounded shadow hover:brightness-110 transition"
      >
        Reset
      </button>
    </div>
    ...
    {timerActive ? "Running" : "Paused"}
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-6 shadow-xl flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto space-y-3">
            {files.length === 0 && (
              <div className="text-sm font-mono text-gold-200 bg-white/5 border border-white/10 backdrop-blur-md px-4 py-3 rounded-lg text-center shadow-sm">
              ...
              >
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="bg-gold-300 text-black font-orbitron text-sm uppercase tracking-wide px-4 py-2 rounded-md shadow hover:brightness-110 transition"
                  >
                    Download
                  </button>
